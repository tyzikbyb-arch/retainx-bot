...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12" style={{ background: "var(--bg)" }}>
      <div className="fixed pointer-events-none" style={{ width: 600, height: 600, borderRadius: "50%", background: "var(--accent)", opacity: 0.07, filter: "blur(120px)", top: "30%", left: "50%", transform: "translateX(-50%)" }} />
      <div className="relative z-10 w-full max-w-4xl flex flex-col md:flex-row gap-8 items-start">
        <div className="flex-1 md:pt-8">
          <Link href="/" className="inline-flex items-center gap-2 font-bold text-xl mb-8 block" style={{ textDecoration: "none" }}>
            ...
            <span style={{ background: "linear-gradient(135deg,#a78bfa,#7c3aed,#06b6d4)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>RetainX Studio</span>
          </Link>
          <h1 className="text-3xl font-black mb-4 leading-tight">Start creating with<br /><span style={{ background: "linear-gradient(135deg,#a78bfa,#06b6d4)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>every AI model</span></h1>
