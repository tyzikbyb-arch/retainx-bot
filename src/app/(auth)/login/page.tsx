      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-2xl p-8" style={{ background: "var(--bg-card)", border: "1px solid var(--border)" }}>
          ...
          <div className="mt-6 pt-6" style={{ borderTop: "1px solid var(--border)" }}>
            <p className="text-sm text-center" style={{ color: "var(--text-muted)" }}>Don&apos;t have an account?{" "}<Link href="/register" style={{ color: "var(--accent-bright)", textDecoration: "none", fontWeight: 600 }}>Sign up free</Link></p>
          </div>
        </div>
      </div>
    </div>
