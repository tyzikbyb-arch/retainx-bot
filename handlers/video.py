...
@router.callback_query(F.data == "att_vid_required_alert")
async def att_vid_required_alert(cb: CallbackQuery, state: FSMContext):
    await cb.answer("Please upload a video reference first.", show_alert=True)
