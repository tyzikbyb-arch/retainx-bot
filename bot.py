...
ADMIN_KB = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton(text="≡  All Orders"),  KeyboardButton(text="✉  Msg User")],
        [KeyboardButton(text="＋  Add Coins"),   KeyboardButton(text="📤  Deliver")],
        [KeyboardButton(text="✕  Cancel Order"), KeyboardButton(text="◌  Admin Help")],
    ],
    resize_keyboard=True,
    persistent=True,
)
...
PANEL_BUTTONS = {
    ...
    "📤  Deliver", "✕  Cancel Order", "◌  Admin Help",
}
...
async def panel_router(msg: Message, state: FSMContext):
    ...
    elif text == "◌  Admin Help" and uid == ADMIN_ID:
        await msg.answer(
            "◈  <b>Admin Commands</b>\n━━━━━━━━━━━━━━━━━━━━\n\n"
            "/msg USER_ID TEXT — send message\n"
            "/addcoins USER_ID AMOUNT — add coins\n"
            "/deliver USER_ID ORDER_ID — deliver file\n"
            "/cancelorder ORDER_ID — cancel & refund\n"
