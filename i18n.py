...
STR = {
    "en": {
        ...
        "help_video_text": (
            ...
            "  Wan 2.7 · LTX 2.3 Pro · Veo 3.1 Lite · Grok 1.5\n\n"
        ...
        "help_vid_std_text": (
            ...
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            "<b>Seedance 2.0</b>\n"
            "  480p / 720p / 1080p / 4K  ·  4–15 sec\n"
            "  from 10◈ (480p 4s)  to 406◈ (4K 15s)\n\n"
            "<b>Seedance 2.0 Fast</b>\n"
            "  480p / 720p  ·  4–15 sec\n"
            "  from 8◈ (480p 4s)  to 64◈ (720p 15s)\n\n"
            "<b>Wan 2.7</b>\n"
            "  720p / 1080p  ·  2–15 sec\n"
            "  from 4◈ (720p 2s)  to 47◈ (1080p 15s)\n\n"
            "<b>LTX 2.3 Pro</b>\n"
            "  720p / 1080p / 2K / 4K  ·  6–10 sec\n"
            "  from 6◈ (720p 6s)  to 75◈ (4K 10s)\n\n"
            "<b>Veo 3.1 Lite</b>\n"
            "  720p / 1080p  ·  4–8 sec  ·  flat per video\n"
            "  4◈ (720p)  ·  5◈ (1080p)\n\n"
            "<b>Grok 1.5</b>\n"
        ...
        "help_vid_prem_text": (
            ...
            "  720p / 1080p / 4K  ·  4–8 sec  ·  flat per video\n"
            "  33◈ (720p / 1080p)  ·  48◈ (4K)\n\n"
            "<b>Veo 3.1 Fast</b>\n"
            "  720p / 1080p / 4K  ·  4–8 sec  ·  flat per video\n"
            "  8◈ (720p / 1080p)  ·  23◈ (4K)\n\n"
        ...
        # ── Suno Music ──
        "btn_music_generation":     "🎵  Suno Music",
        "suno_select_feature":      "  Choose a feature:",
        "suno_btn_generate_music":  "🎵  Generate Music",
        "suno_btn_stem_separation": "✂️  Stem Separation",
        "suno_btn_generate_lyrics": "📝  Generate Lyrics",
        "suno_select_model":        "  Select a Suno model:",
        "suno_enter_prompt":        "  Describe the music you want to create.\n  (style, mood, genre, instruments — any language)",
        "suno_enter_style":         "  Enter a style tag (e.g. \"dark pop, piano, female vocals\").\n  This sets the musical style separately from the prompt.",
        "suno_enter_stem_name":     "  Enter the stem name to extract\n  (e.g. \"vocals\", \"drums\", \"bass\", \"guitar\"):",
        "suno_upload_audio":        "  Send the audio file you want to separate:",
        "suno_send_audio_file":     "  Please send an audio file (MP3, WAV, M4A, etc.).",
        "suno_enter_lyrics_prompt": "  Describe the lyrics topic or mood ({coins}◈):",
        "suno_select_vocal_type":   "  Choose a separation type:",
        "suno_order_summary":       "🎵  Order Summary",
        "suno_model_label":         "Model",
        "suno_type_label":          "Type",
        "suno_stem_label":          "Stem",
        "suno_style_label":         "Style",
        "suno_prompt_label":        "Prompt:",
        "suno_instrumental_label":  "Instrumental",
        "suno_instrumental_on":     "✓  Instrumental",
        "suno_instrumental_off":    "◌  With Vocals",
        "suno_cost_label":          "Cost",
        "suno_balance_label":       "Balance",
        "suno_btn_confirm":         "✓  Confirm  ·  {coins}◈",
        "suno_btn_add_style":       "＋  Add Style",
        "suno_btn_edit_prompt":     "✎  Edit Prompt",
        "suno_coins_deducted":      "  Coins deducted   <b>{coins}◈</b>",
        "suno_estimated_delivery":  "  Estimated delivery: ~{minutes} min",
        "suno_will_deliver_music":  "  Two tracks will be delivered here in this chat.",
        "suno_will_deliver_vocal":  "  Separated stems will be delivered here in this chat.",
        "suno_will_deliver_lyrics": "  Your lyrics will be delivered here in this chat.",
        "suno_order_placed_music":  "Suno Music order #{oid} placed!",
        "suno_order_placed_vocal":  "Suno Stem order #{oid} placed!",
        "suno_order_placed_lyrics": "Suno Lyrics order #{oid} placed!",
        "suno_session_expired":     "Session expired, please start over.",
        "suno_insufficient_coins":  "Insufficient coins. Please top up your wallet.",
        "suno_select_mode":         "  Choose a mode:",
        "suno_btn_mode_normal":     "🔓  Normal Mode",
        "suno_btn_mode_custom":     "✏️  Custom Mode",
        "suno_mode_normal_label":   "Normal",
        "suno_mode_custom_label":   "Custom",
        "suno_enter_title":         "  Enter the song title (optional):",
        "suno_enter_custom_lyrics": "  Enter the song lyrics:",
        "suno_title_label":         "Title",
        "suno_lyrics_label":        "Lyrics:",
        "suno_voice_auto":          "🎤  Voice: Auto",
        "suno_voice_male":          "🎤  ♂ Male",
        "suno_voice_female":        "🎤  ♀ Female",
        "suno_sec":                 "sec",
        "suno_btn_edit_lyrics":     "✎  Edit Lyrics",
        "suno_btn_edit_style":      "✎  Edit Style",
        "suno_btn_skip":            "/  Skip",
        "coins_word":               "coins",
        ...
        "img_btn_add_more_refs": "◈  Add more images  ({count}/{max})",
        ...
        "vid_flat_price": "flat price per video",
    ...
    "ru": {
        ...
        "help_start_text": (
            ...
            "  <b>Стартовый бонус</b>\n"
            "  5 монет бесплатно при первом запуске 🎁\n\n"
            "  <b>Промо-коды</b>\n"
        ...
        "help_video_text": (
            ...
            "  Seedance 2.0 · Seedance 2.0 Fast · Wan 2.7\n"
            "  LTX 2.3 Pro · Veo 3.1 Lite · Grok 1.5\n\n"
        ...
        "help_vid_std_text": (
            ...
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            "<b>Seedance 2.0</b>\n"
            "  480p / 720p / 1080p / 4K  ·  4–15 сек\n"
            "  от 10◈ (480p 4с)  до 406◈ (4K 15с)\n\n"
            "<b>Seedance 2.0 Fast</b>\n"
            "  480p / 720p  ·  4–15 сек\n"
            "  от 8◈ (480p 4с)  до 64◈ (720p 15с)\n\n"
            "<b>Wan 2.7</b>\n"
            "  720p / 1080p  ·  2–15 сек\n"
            "  от 4◈ (720p 2с)  до 47◈ (1080p 15с)\n\n"
            "<b>LTX 2.3 Pro</b>\n"
            "  720p / 1080p / 2K / 4K  ·  6–10 сек\n"
            "  от 6◈ (720p 6с)  до 75◈ (4K 10с)\n\n"
            "<b>Veo 3.1 Lite</b>\n"
            "  720p / 1080p  ·  4–8 сек  ·  фиксированная цена\n"
            "  4◈ (720p)  ·  5◈ (1080p)\n\n"
            "<b>Grok 1.5</b>\n"
        ...
        "help_vid_prem_text": (
            ...
            "  720p / 1080p / 4K  ·  4–8 сек  ·  фиксированная цена\n"
            "  33◈ (720p / 1080p)  ·  48◈ (4K)\n\n"
            "<b>Veo 3.1 Fast</b>\n"
            "  720p / 1080p / 4K  ·  4–8 сек  ·  фиксированная цена\n"
            "  8◈ (720p / 1080p)  ·  23◈ (4K)\n\n"
        ...
        "tts_chars_label":      "  Символов: {chars}",
        ...
        # ── Suno Music ──
        "btn_music_generation":     "🎵  Suno Music",
        "suno_select_feature":      "  Выберите функцию:",
        "suno_btn_generate_music":  "🎵  Генерировать музыку",
        "suno_btn_stem_separation": "✂️  Разделение треков",
        "suno_btn_generate_lyrics": "📝  Генерировать текст",
        "suno_select_model":        "  Выберите модель Suno:",
        "suno_enter_prompt":        "  Опишите музыку, которую хотите создать.\n  (стиль, настроение, жанр, инструменты — любой язык)",
        "suno_enter_style":         "  Введите тег стиля (например: «dark pop, piano, female vocals»).\n  Он задаёт музыкальный стиль отдельно от промпта.",
        "suno_enter_stem_name":     "  Укажите название трека для извлечения\n  (например: \"vocals\", \"drums\", \"bass\", \"guitar\"):",
        "suno_upload_audio":        "  Отправьте аудиофайл для разделения:",
        "suno_send_audio_file":     "  Пожалуйста, отправьте аудиофайл (MP3, WAV, M4A и др.).",
        "suno_enter_lyrics_prompt": "  Опишите тему или настроение текста ({coins}◈):",
        "suno_select_vocal_type":   "  Выберите тип разделения:",
        "suno_order_summary":       "🎵  Сводка заказа",
        "suno_model_label":         "Модель",
        "suno_type_label":          "Тип",
        "suno_stem_label":          "Трек",
        "suno_style_label":         "Стиль",
        "suno_prompt_label":        "Промпт:",
        "suno_instrumental_label":  "Инструментал",
        "suno_instrumental_on":     "✓  Инструментал",
        "suno_instrumental_off":    "◌  С вокалом",
        "suno_cost_label":          "Стоимость",
        "suno_balance_label":       "Баланс",
        "suno_btn_confirm":         "✓  Подтвердить  ·  {coins}◈",
        "suno_btn_add_style":       "＋  Добавить стиль",
        "suno_btn_edit_prompt":     "✎  Изменить промпт",
        "suno_coins_deducted":      "  Списано монет   <b>{coins}◈</b>",
        "suno_estimated_delivery":  "  Ожидаемое время: ~{minutes} мин",
        "suno_will_deliver_music":  "  Два трека будут доставлены прямо в этот чат.",
        "suno_will_deliver_vocal":  "  Разделённые треки будут доставлены прямо в этот чат.",
        "suno_will_deliver_lyrics": "  Текст песни будет доставлен прямо в этот чат.",
        "suno_order_placed_music":  "Заказ Suno Music #{oid} оформлен!",
        "suno_order_placed_vocal":  "Заказ Suno Stem #{oid} оформлен!",
        "suno_order_placed_lyrics": "Заказ Suno Lyrics #{oid} оформлен!",
        "suno_session_expired":     "Сессия истекла, начните заново.",
        "suno_insufficient_coins":  "Недостаточно монет. Пополните кошелёк.",
        "suno_select_mode":         "  Выберите режим:",
        "suno_btn_mode_normal":     "🔓  Обычный режим",
        "suno_btn_mode_custom":     "✏️  Кастомный режим",
        "suno_mode_normal_label":   "Обычный",
        "suno_mode_custom_label":   "Кастом",
        "suno_enter_title":         "  Введите название трека (необязательно):",
        "suno_enter_custom_lyrics": "  Введите текст песни:",
        "suno_title_label":         "Название",
        "suno_lyrics_label":        "Текст:",
        "suno_voice_auto":          "🎤  Голос: Авто",
        "suno_voice_male":          "🎤  ♂ Муж",
        "suno_voice_female":        "🎤  ♀ Жен",
        "suno_sec":                 "сек",
        "suno_btn_edit_lyrics":     "✎  Текст",
        "suno_btn_edit_style":      "✎  Стиль",
        "suno_btn_skip":            "/  Пропустить",
        "coins_word":               "монет",
        ...
        "img_btn_add_more_refs": "◈  Добавить ещё  ({count}/{max})",
        ...
        "vid_flat_price": "единая цена за видео",
    ...
    "ar": {
        ...
        "help_vid_std_text": (
            ...
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            "<b>Seedance 2.0</b>\n"
            "  480p / 720p / 1080p / 4K  ·  4–15 ثانية\n"
            "  من 10◈ (480p 4ث)  إلى 406◈ (4K 15ث)\n\n"
            "<b>Seedance 2.0 Fast</b>\n"
            "  480p / 720p  ·  4–15 ثانية\n"
            "  من 8◈ (480p 4ث)  إلى 64◈ (720p 15ث)\n\n"
            "<b>Wan 2.7</b>\n"
            "  720p / 1080p  ·  2–15 ثانية\n"
            "  من 4◈ (720p 2ث)  إلى 47◈ (1080p 15ث)\n\n"
            "<b>LTX 2.3 Pro</b>\n"
            "  720p / 1080p / 2K / 4K  ·  6–10 ثانية\n"
            "  من 6◈ (720p 6ث)  إلى 75◈ (4K 10ث)\n\n"
            "<b>Veo 3.1 Lite</b>\n"
            "  720p / 1080p  ·  4–8 ثانية  ·  سعر ثابت لكل فيديو\n"
            "  4◈ (720p)  ·  5◈ (1080p)\n\n"
            "<b>Grok 1.5</b>\n"
        ...
        "help_vid_prem_text": (
            ...
            "  720p / 1080p / 4K  ·  4–8 ثانية  ·  سعر ثابت لكل فيديو\n"
            "  33◈ (720p / 1080p)  ·  48◈ (4K)\n\n"
            "<b>Veo 3.1 Fast</b>\n"
            "  720p / 1080p / 4K  ·  4–8 ثانية  ·  سعر ثابت لكل فيديو\n"
            "  8◈ (720p / 1080p)  ·  23◈ (4K)\n\n"
        ...
        # ── Suno Music ──
        "btn_music_generation":     "🎵  Suno Music",
        "suno_select_feature":      "  اختر ميزة:",
        "suno_btn_generate_music":  "🎵  توليد موسيقى",
        "suno_btn_stem_separation": "✂️  فصل المسارات",
        "suno_btn_generate_lyrics": "📝  توليد كلمات",
        "suno_select_model":        "  اختر نموذج Suno:",
        "suno_enter_prompt":        "  صِف الموسيقى التي تريد إنشاءها.\n  (الأسلوب، المزاج، النوع، الآلات — بأي لغة)",
        "suno_enter_style":         "  أدخل وسم الأسلوب (مثال: «dark pop, piano, female vocals»).\n  يحدد هذا الأسلوب الموسيقي بشكل منفصل عن الوصف.",
        "suno_enter_stem_name":     "  أدخل اسم المسار المراد استخراجه\n  (مثال: \"vocals\"، \"drums\"، \"bass\"، \"guitar\"):",
        "suno_upload_audio":        "  أرسل ملف الصوت الذي تريد فصله:",
        "suno_send_audio_file":     "  يرجى إرسال ملف صوتي (MP3، WAV، M4A، إلخ).",
        "suno_enter_lyrics_prompt": "  صِف موضوع الكلمات أو المزاج ({coins}◈):",
        "suno_select_vocal_type":   "  اختر نوع الفصل:",
        "suno_order_summary":       "🎵  ملخص الطلب",
        "suno_model_label":         "النموذج",
        "suno_type_label":          "النوع",
        "suno_stem_label":          "المسار",
        "suno_style_label":         "الأسلوب",
        "suno_prompt_label":        "الوصف:",
        "suno_instrumental_label":  "موسيقى فقط",
        "suno_instrumental_on":     "✓  موسيقى فقط",
        "suno_instrumental_off":    "◌  مع صوت",
        "suno_cost_label":          "التكلفة",
        "suno_balance_label":       "الرصيد",
        "suno_btn_confirm":         "✓  تأكيد  ·  {coins}◈",
        "suno_btn_add_style":       "＋  إضافة أسلوب",
        "suno_btn_edit_prompt":     "✎  تعديل الوصف",
        "suno_coins_deducted":      "  العملات المخصومة   <b>{coins}◈</b>",
        "suno_estimated_delivery":  "  الوقت المتوقع: ~{minutes} دقيقة",
        "suno_will_deliver_music":  "  سيتم إرسال مسارين مباشرةً في هذه المحادثة.",
        "suno_will_deliver_vocal":  "  سيتم إرسال المسارات المفصولة مباشرةً في هذه المحادثة.",
        "suno_will_deliver_lyrics": "  سيتم إرسال كلمات الأغنية مباشرةً في هذه المحادثة.",
        "suno_order_placed_music":  "تم تقديم طلب Suno Music #{oid}!",
        "suno_order_placed_vocal":  "تم تقديم طلب Suno Stem #{oid}!",
        "suno_order_placed_lyrics": "تم تقديم طلب Suno Lyrics #{oid}!",
        "suno_session_expired":     "انتهت الجلسة، يرجى البدء من جديد.",
        "suno_insufficient_coins":  "رصيد غير كافٍ. يرجى شحن المحفظة.",
        "suno_select_mode":         "  اختر الوضع:",
        "suno_btn_mode_normal":     "🔓  الوضع العادي",
        "suno_btn_mode_custom":     "✏️  الوضع المخصص",
        "suno_mode_normal_label":   "عادي",
        "suno_mode_custom_label":   "مخصص",
        "suno_enter_title":         "  أدخل عنوان الأغنية (اختياري):",
        "suno_enter_custom_lyrics": "  أدخل كلمات الأغنية:",
        "suno_title_label":         "العنوان",
        "suno_lyrics_label":        "الكلمات:",
        "suno_voice_auto":          "🎤  الصوت: تلقائي",
        "suno_voice_male":          "🎤  ♂ ذكر",
        "suno_voice_female":        "🎤  ♀ أنثى",
        "suno_sec":                 "ث",
        "suno_btn_edit_lyrics":     "✎  تعديل الكلمات",
        "suno_btn_edit_style":      "✎  تعديل الأسلوب",
        "suno_btn_skip":            "/  تخطى",
        "coins_word":               "عملة",
        ...
        "img_btn_add_more_refs": "◈  إضافة المزيد  ({count}/{max})",
        ...
        "vid_flat_price": "سعر ثابت للفيديو",
